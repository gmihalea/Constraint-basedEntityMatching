...
public class ViewConstants {
    ...
    public static final String SUGGESTED_RESULTS_FILE_NAME = "matchingResults.xls";
    public static final String SUGGESTED_STATISTICS_FILE_NAME = "matchingStatistics.xls";
